...
def flight_data():
    ...
    results = session.query(Flight.FL_DATE, Flight.DEP_HOUR, Flight.OP_UNIQUE_CARRIER, Flight.OP_CARRIER_FL_NUM, Flight.TAIL_NUM, Flight.ORIGIN, Flight.DEST, Flight.DEP_TIME, Flight.CRS_DEP_TIME, Flight.TAXI_OUT, Flight.DEP_DELAY, Flight.AIR_TIME, Flight.CANCELLED, Flight.YEAR_OF_MANUFACTURE, Flight.MANUFACTURER, Flight.ICAO_TYPE, Flight.ACTIVE_WEATHER).all()

    # Create a dictionary from the row data and append to a list of all_passengers
    all_flight_data = []
    for FL_DATE, DEP_HOUR, OP_UNIQUE_CARRIER, OP_CARRIER_FL_NUM, TAIL_NUM, ORIGIN, DEST, DEP_TIME, CRS_DEP_TIME, TAXI_OUT, DEP_DELAY, AIR_TIME, CANCELLED, YEAR_OF_MANUFACTURE, MANUFACTURER, ICAO_TYPE, ACTIVE_WEATHER in results:
        flight_dict = {}
        ...
        flight_dict["CRS_DEP_TIME"] = CRS_DEP_TIME
